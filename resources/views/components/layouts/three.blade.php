                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="single-main-default-news">
                            <a href="#">
                                <img src="{{asset('assets/img/main-default-news/main-default-news-1.jpg')}}" alt="image">
                            </a>
                        ...
                        <div class="single-main-default-news">
                            <a href="#">
                                <img src="{{asset('assets/img/main-default-news/main-default-news-2.jpg')}}" alt="image">
                            </a>
                            <div class="news-content">
                    ...
                    <div class="col-lg-6">
                        <div class="single-main-default-news-inner">
                            <a href="#">
                                <img src="{{asset('assets/img/main-default-news/main-default-news-3.jpg')}}" alt="image">
                            </a>
                            <div class="news-content">
                                <div class="tag">World news</div>
                                <h3>
                                    <a href="#">Administration officials are working hard to prevent various militant attacks</a>
                                </h3>
                                <span>28 September, 2022</span>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3">
                        <div class="single-main-default-news">
                            <a href="#">
                                <img src="{{asset('assets/img/main-default-news/main-default-news-4.jpg')}}" alt="image">
                            </a>
                            <div class="news-content">
                                <div class="tag">World news</div>
                                <h3>
                                    <a href="#">Speech to the nation on the current situation and the warning of Covid-19</a>
                                </h3>
                                <span>28 September, 2022</span>
                            </div>
                        </div>
                        ...
                        <div class="single-main-default-news">
                            <a href="#">
                                <img src="{{asset('assets/img/main-default-news/main-default-news-5.jpg')}}" alt="image">
                            </a>
                            <div class="news-content">
                                <div class="tag">Culture</div>
                                <h3>
                                    <a href="#">Always trump in front of the camera in a state of laughter</a>
                                </h3>
                                <span>28 September, 2022</span>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="single-most-popular-news">
                                        <div class="popular-news-image">
                                            <a href="#">
                                                <img src="{{asset('assets/img/most-popular/most-popular-1.jpg')}}" alt="image">
                                            </a>
                                        </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="single-most-popular-news">
                                        <div class="popular-news-image">
                                            <a href="#">
                                                <img src="{{asset('assets/img/most-popular/most-popular-7.jpg')}}" alt="image">
                                            </a>
                                        </div>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-lg-4 col-sm-4">
                                        <div class="post-image">
                                            <a href="#">
                                                <img src="{{asset('assets/img/most-popular/most-popular-3.jpg')}}" alt="image">
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="most-popular-post">
                                <div class="row align-items-center">
                                    <div class="col-lg-4 col-sm-4">
                                        <div class="post-image">
                                            <a href="#">
                                                <img src="{{asset('assets/img/most-popular/most-popular-4.jpg')}}" alt="image">
                                            </a>
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-6">
                            <div class="single-politics-news">
                                <div class="politics-news-image">
                                    <a href="#">
                                        <img src="{{asset('assets/img/politics-news/politics-news-6.jpg')}}" alt="image">
                                    </a>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <div class="politics-news-post-box">
                                        <a href="#">
                                            <img src="{{asset('assets/img/politics-news/politics-news-7.jpg')}}" alt="image">
                                        </a>
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="politics-news-post-box">
                                        <a href="#">
                                            <img src="{{asset('assets/img/politics-news/politics-news-8.jpg')}}" alt="image">
                                        </a>
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="politics-news-post-box">
                                        <a href="#">
                                            <img src="{{asset('assets/img/politics-news/politics-news-9.jpg')}}" alt="image">
                                        </a>
                                        
                                        <div class="politics-news-content">
                                            <h3>
                                                <a href="#">Movement with 5 major issues keeping the people together</a>
                                            </h3>
                                            <p>28 September, 2022</p>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="politics-news-post-box">
                                        <a href="#">
                                            <img src="{{asset('assets/img/politics-news/politics-news-10.jpg')}}" alt="image">
                                        </a>
                                        
                                        <div class="politics-news-content">
                                            <h3>
                                                <a href="#">Giving special powers to police officers to prevent crime</a>
                                            </h3>
                                            <p>28 September, 2022</p>
                                        </div>
                                    </div>
                    ...
                    <div class="video-slides owl-carousel owl-theme">
                        <div class="video-item">
                            <div class="video-news-image">
                                <a href="#">
                                    <img src="{{asset('assets/img/video-news/video-news-1.jpg')}}" alt="image">
                                </a>
                        ...
                        <div class="video-item">
                            <div class="video-news-image">
                                <a href="#">
                                    <img src="{{asset('assets/img/video-news/video-news-2.jpg')}}" alt="image">
                                </a>
                        ...
                        <div class="video-item">
                            <div class="video-news-image">
                                <a href="#">
                                    <img src="{{asset('assets/img/video-news/video-news-3.jpg')}}" alt="image">
                                </a>
                        ...
                        <div class="business-news">
                            ...
                            <div class="business-news-slides owl-carousel owl-theme">
                                ...
                                <div class="single-business-news">
                                    <div class="business-news-image">
                                        <a href="#">
                                            <img src="{{asset('assets/img/business-news/business-news-3.jpg')}}" alt="image">
                                        </a>
                                    </div>
                                ...
                                <div class="single-business-news">
                                    <div class="business-news-image">
                                        <a href="#">
                                            <img src="{{asset('assets/img/business-news/business-news-4.jpg')}}" alt="image">
                                        </a>
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="single-sports-news-box">
                                        <div class="sports-news-image">
                                            <a href="#">
                                                <img src="{{asset('assets/img/sports-news/sports-news-4.jpg')}}" alt="image">
                                            </a>
                                        </div>
                                    ...
                                    <div class="sports-news-post">
                                        <div class="row align-items-center">
                                            <div class="col-lg-4 col-sm-4">
                                                <div class="sports-news-image">
                                                    <a href="#">
                                                        <img src="{{asset('assets/img/sports-news/sports-news-1.jpg')}}" alt="image">
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="sports-news-post">
                                        <div class="row align-items-center">
                                            <div class="col-lg-4 col-sm-4">
                                                <div class="sports-news-image">
                                                    <a href="#">
                                                        <img src="{{asset('assets/img/sports-news/sports-news-2.jpg')}}" alt="image">
                                                    </a>
                                                </div>
                                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-sm-6">
                                    <div class="single-tech-news-box">
                                        <a href="#">
                                            <img src="{{asset('assets/img/tech-news/tech-news-1.jpg')}}" alt="image">
                                        </a>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    <div class="single-tech-news-box">
                                        <a href="#">
                                            <img src="{{asset('assets/img/tech-news/tech-news-2.jpg')}}" alt="image">
                                        </a>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    <div class="single-tech-news-box">
                                        <a href="#">
                                            <img src="{{asset('assets/img/tech-news/tech-news-3.jpg')}}" alt="image">
                                        </a>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="single-culture-news">
                                <div class="culture-news-image">
                                    <a href="#">
                                        <img src="{{asset('assets/img/culture-news/culture-news-7.jpg')}}" alt="image">
                                    </a>
                                </div>
                                ...
                                <div class="culture-news-content">
                                    <span>News</span>
                                    <h3>
                                        <a href="#">Tourist centers of different countries have once againg become popular among tourists.</a>
                                    </h3>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="single-culture-news">
                                <div class="culture-news-image">
                                    <a href="#">
                                        <img src="{{asset('assets/img/culture-news/culture-news-8.jpg')}}" alt="image">
                                    </a>
                                </div>
                                ...
                                <div class="culture-news-content">
                                    <span>Culture</span>
                                    <h3>
                                        <a href="#">After a long period of about 7 months, the people of different countries have become vocal again.</a>
                                    </h3>
                                    <p><a href="#">Steven</a> / 28 September, 2022</p>
                                </div>
                            </div>
                            ...
                            <div class="culture-news-post">
                                <div class="row align-items-center">
                                    <div class="col-lg-4 col-sm-4">
                                        <div class="culture-news-image">
                                            <a href="#">
                                                <img src="{{asset('assets/img/culture-news/culture-news-5.jpg')}}" alt="image">
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="culture-news-post">
                                <div class="row align-items-center">
                                    <div class="col-lg-4 col-sm-4">
                                        <div class="culture-news-image">
                                            <a href="#">
                                                <img src="{{asset('assets/img/culture-news/culture-news-6.jpg')}}" alt="image">
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <div class="single-health-news">
                                        <div class="health-news-image">
                                            <a href="#">
                                                <img src="{{asset('assets/img/health-news/health-news-3.jpg')}}" alt="image">
                                            </a>
                                        </div>
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="single-health-news">
                                        <div class="health-news-image">
                                            <a href="#">
                                                <img src="{{asset('assets/img/health-news/health-news-4.jpg')}}" alt="image">
                                            </a>
                                        </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="health-news-post">
                                        <div class="row align-items-center">
                                            <div class="col-lg-4 col-sm-4">
                                                <div class="health-news-image">
                                                    <a href="#">
                                                        <img src="{{asset('assets/img/health-news/health-news-5.jpg')}}" alt="image">
                                                    </a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-8 col-sm-8">
                                                <div class="health-news-content">
                                                    <span>News</span>
                                                    <h3>
                                                        <a href="#">On the advice of the doctor, Dr. Katherine Chavez forbids taking the whole medicine</a>
                                                    </h3>
                                    ...
                                    <div class="health-news-post">
                                        <div class="row align-items-center">
                                            <div class="col-lg-4 col-sm-4">
                                                <div class="health-news-image">
                                                    <a href="#">
                                                        <img src="{{asset('assets/img/health-news/health-news-6.jpg')}}" alt="image">
                                                    </a>
                                                </div>
                                            </div>
                                ...
                                <section class="widget widget_most_shared">
                                    ...
                                    <div class="single-most-shared">
                                        <div class="most-shared-image">
                                            <a href="#">
                                                <img src="{{asset('assets/img/most-shared/most-shared-2.jpg')}}" alt="image">
                                            </a>
